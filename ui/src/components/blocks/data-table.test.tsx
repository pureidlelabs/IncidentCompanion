...
describe('a row whose only offer is its menu', () => {
  ...
  /**
   * The cluster is what the menu is anchored to, so a menu open over a cluster
   * at `opacity: 0` is a popover hanging off nothing.
   */
  ...
  /**
   * Pressing the overflow itself is the gesture that was already there.
   */
   ...
   * must stay inert rather than gain an action that opens nothing.
   */
