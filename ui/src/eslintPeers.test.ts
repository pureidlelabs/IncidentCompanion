 ...
 * about that one.
 *
 * **A forced peer resolution is a decision with no expiry**, so this fails
 * once the reason is gone and is the reminder to delete the line. The flag
 * weakens every peer check in the client, and should live exactly as long as
 * what forced it.
 *
