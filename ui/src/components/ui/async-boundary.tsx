...
export function AsyncBoundary({
  ...
  if (isError) {
    /**
     * **A refusal is not a failure, and offering to retry one is a lie.** An
     * analyst opening a pane they may not reach gets a red alert reading
     * "Insufficient permissions" with *Try again* beside it. The server is
     * right and refuses every press, so the button invites the analyst to keep
      ...
      >
        {/*
          **No 409 branch here.** This boundary wraps reads, and this server
          answers 409 only on a versioned write, which is a path no read
          reaches.
        */}
