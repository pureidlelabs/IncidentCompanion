...
| V6.1.1 | Documentation of how rate limiting, anti-automation and adaptive response defend against credential stuffing and brute force, how they are configured, and how they prevent malicious account lockout | accounts-and-access :: Authentication resists guessing, and says so to the auditor |
...
| V6.1.3, V7.1.1, V7.1.2, V8.1.1 | The documentation these controls require | these specifications are that documentation, and this matrix is how it is found |
