...
const button = tv({
  ...
  variants: {
    ...
    size: {
      ...
      sm: 'min-h-control-sm gap-1 rounded-md px-2.5 text-sm [&_svg:not([class*=size-])]:size-3.5',
      default: 'min-h-control-md gap-1.5 px-2.5',
      lg: 'min-h-control-lg gap-1.5 px-2.5',
