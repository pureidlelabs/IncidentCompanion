 ...
 */
export const routes = withAriaRouting([
...
let made: Router | undefined

/**
 * The app's router, made on first call rather than at import: a browser router
 * reads the address when it is made, and the demo moves the address before the
 * app renders.
 */
export function appRouter(): Router {
  made ??= createBrowserRouter(routes, { basename: import.meta.env.BASE_URL })
  return made
}
