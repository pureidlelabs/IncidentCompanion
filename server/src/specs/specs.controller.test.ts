...
/**
 * The forms `EntityDialog` draws, which is the set that owes a tier.
 *
...
describe('the blank row a form carries', () => {
  ...
  /**
   * **The gap `blankOf` cannot fill, made loud.** A field it has no blank for
   ...
   * schema never declared `null` becoming one, which is the case `blankOf`
   * cannot answer.
   */
