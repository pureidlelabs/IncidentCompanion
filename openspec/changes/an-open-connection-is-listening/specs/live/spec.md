...
A connection the browser can write to MUST act on everything written over it. Where the install has accepted a connection and is still preparing it, what arrives in the meantime MUST be held and acted on once it is ready, never discarded.
