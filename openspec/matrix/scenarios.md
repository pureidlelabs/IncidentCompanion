...
| Written prose is edited together, not saved over | A writer is disabled before the words are stored | demonstrated | server/test/accepted-words-are-kept-past-their-writers-reach.test.ts :: words accepted before their writer loses write > stores what a writer typed before their account was disabled, named for them |
