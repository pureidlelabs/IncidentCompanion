...
## 1. Prose typed before a send is named

- [x] 1.1 Save and attribute unsaved prose before a send holds it, one save at a time, and verify with the send case in `server/test/prose-names-whoever-wrote-it.test.ts`

## 2. An analyst's own reorder never refuses their next
