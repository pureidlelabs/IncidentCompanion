...
export function CodeBlock({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="flex h-(--control-h-md) items-center justify-between gap-2 border-b border-border bg-muted px-2">
        <span className="truncate text-xs font-medium tracking-wide text-ink-muted uppercase">
          {label ?? grammar}
        </span>
