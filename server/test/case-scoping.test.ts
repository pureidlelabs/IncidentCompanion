 ...
 *
 * **Who may read a case is asserted elsewhere**, at the route and in the store
 * (`a-route-that-forgets-its-guard-serves-nothing.test.ts`). This asserts that
 * reading one case, as somebody who reaches both, never returns the other's
 * rows.
 *
