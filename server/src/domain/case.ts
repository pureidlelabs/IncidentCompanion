 ...
 *
 * **Here rather than in `cases.dto.ts`, because two doors ask it.** The route
 * is one and the evaluation build is the other, and a build judging a write by
 * a copy is the drift `evaluation/design.md` refuses.
 */
