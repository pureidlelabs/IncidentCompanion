...
| A case is one case however it is named | An analyst names the case in another spelling | demonstrated | server/test/a-case-is-one-room-however-it-is-spelled.test.ts :: a case named in capitals over the live connection > puts the analyst in the roster the others see ; server/test/a-case-is-one-room-however-it-is-spelled.test.ts :: a case named in capitals over the live connection > refuses the case deletion while they are connected, by either spelling of the route ; server/test/a-case-is-one-room-however-it-is-spelled.test.ts :: a case named in capitals over the live connection > holds one claim on an entry whichever spelling each analyst claims it by |
