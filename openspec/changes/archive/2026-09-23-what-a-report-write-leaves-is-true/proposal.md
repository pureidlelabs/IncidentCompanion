...
- Removing the report a sent report corrects is refused with the sent report's refusal. Only a case removed with everything in it, an account removed with its name cleared from what it wrote, and a piece of evidence removed from under a sent figure pass the freeze.
...
- Deleting a report that a sent report corrects answers 409 where it answered 200.
