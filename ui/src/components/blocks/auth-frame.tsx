 ...
 *
 * - No card. The form sits on the pane, which is already `bg-surface`; there is
...
export function AuthFrame({
  ...
  return (
    <div data-part="auth-layout" className="relative flex min-h-screen">
      ...
      <main className="relative z-10 flex w-full shrink-0 items-center justify-center bg-surface p-6 [--auth-pane-w:30rem] lg:w-(--auth-pane-w) lg:border-l">
