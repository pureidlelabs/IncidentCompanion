...
| A report filed under a regime records which step of it the report is | A filing is created from the layout that files it | demonstrated | ui/src/components/blocks/report-layouts.test.ts |
...
| A report filed under a regime records which step of it the report is | An ordinary layout | demonstrated | server/src/report/offered-layouts.test.ts |
| A report filed under a regime records which step of it the report is | The install does not assess the regime | demonstrated | server/src/report/offered-layouts.test.ts |
