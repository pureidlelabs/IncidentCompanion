...
function fullyAnswered(): ComplianceRecord {
  return {
    ...
    doraRootCauseHigh: ['process failure'],
    doraRootCauseDetailed: ['process failure: insufficient monitoring or failure of monitoring and control'],
    doraRootCauseAdditional: ['logging'],
