...
export function TimelineGraphScreen({
  ...
  return (
    <Section
      title="Timeline graph"
      fills
      blurb="Vertical distance is elapsed time, square-rooted so a long silence stays on the screen."
    >
      <div className="flex min-h-0 flex-1 flex-col gap-4">
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-y-auto rounded-sm border border-border bg-card [scrollbar-gutter:stable]">
          <p
            data-slot="cascade-readout"
            className="sticky top-0 z-20 border-b border-border bg-muted/40 px-3 py-2 text-xs text-ink-muted"
          >
